...
import za.co.RecruitmentZone.service.EventOrchestration.RecruiterEventManagement;
...
class RecruiterController {
    ...
    private final RecruiterEventManagement recruiterService;

    @Autowired
    public RecruiterController(RecruiterEventManagement recruiterService) {
