...
public class Vacancy {
    ...
    public Vacancy(String title, String description, String industry, boolean active, LocalDateTime startDate, LocalDateTime endDate, VacancyStatus status, Recruiter recruiter, List<Application> applications) {
        this.title = title;
